...
class MailtrapService {
  ...
  late final String _apiUrl = dotenv.get('MAILTRAP_API_URL',
      fallback: 'https://send.api.mailtrap.io/api/send');
  late final String _fromEmail = dotenv.get('MAILTRAP_FROM_EMAIL',
      fallback: 'notifications@flexpilates.app');
  ...
  final bool _debugLogging = kDebugMode;
